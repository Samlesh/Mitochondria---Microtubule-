...
initialwmt=stormatrix(:,:,6);%stores the time evolution of cell 6
...
Mwtc6=sum(ffes,3);
%Mwtc6 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell6sectorwmt','Mwtc6');
else
