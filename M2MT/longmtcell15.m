...
initiallmt=stormatrix(:,:,15);%stores the time evolution of cell 5
...
Mltc15=sum(ffes,3);
%Mltc15 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell15sectorlmt','Mltc15','-v7.3');
else
