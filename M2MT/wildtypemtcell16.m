...
initialwmt=stormatrix(:,:,16);%stores the time evolution of cell 16
...
Mwtc16=sum(ffes,3);
%Mwtc16 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell16sectorwmt','Mwtc16');
else
