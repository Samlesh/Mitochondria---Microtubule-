...
initialwmt=stormatrix(:,:,15);%stores the time evolution of cell 15
...
Mwtc15=sum(ffes,3);
%Mwtc15 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell15sectorwmt','Mwtc15');
else
