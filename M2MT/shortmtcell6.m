...
%Asmt stores the mitochondrial length values observed in experiments for 
...
initialsmt=stormatrix(:,:,6);%stores the time evolution of cell 6
...
Mstc6=sum(ffes,3);
%Mstc6 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell6sectorsmt','Mstc6','-v7.3');
else
