...
initialsmt=stormatrix(:,:,7);%stores the time evolution of cell 7
...
Mstc7=sum(ffes,3);
%Mstc7 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell7sectorsmt','Mstc7','-v7.3');
else
