...
initialwmt=stormatrix(:,:,9);%stores the time evolution of cell 9
...
Mwtc9=sum(ffes,3);
%Mwtc9 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell9sectorwmt','Mwtc9');
else
