...
initialwmt=stormatrix(:,:,21);%stores the time evolution of cell 21
...
Mwtc21=sum(ffes,3);
%Mwtc21 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell21sectorwmt','Mwtc21');
else
