...
initiallmt=stormatrix(:,:,6);%stores the time evolution of cell 5
...
Mltc6=sum(ffes,3);
%Mltc6 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell6sectorlmt','Mltc6','-v7.3');
else
