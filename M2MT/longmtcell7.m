...
initiallmt=stormatrix(:,:,7);%stores the time evolution of cell 5
...
Mltc7=sum(ffes,3);
%Mltc7 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell7sectorlmt','Mltc7','-v7.3');
else
