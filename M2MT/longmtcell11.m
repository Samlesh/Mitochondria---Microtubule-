...
initiallmt=stormatrix(:,:,11);%stores the time evolution of cell 5
...
Mltc11=sum(ffes,3);
%Mltc11 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell11sectorlmt','Mltc11','-v7.3');
else
