...
initialwmt=stormatrix(:,:,1);%stores the time evolution of cell 1
...
Mwtc1=sum(ffes,3);
%Mwtc1 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell1sectorwmt','Mwtc1');
else
