...
initialwmt=stormatrix(:,:,11);%stores the time evolution of cell 11
...
Mwtc11=sum(ffes,3);
%Mwtc11 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell11sectorwmt','Mwtc11');
else
