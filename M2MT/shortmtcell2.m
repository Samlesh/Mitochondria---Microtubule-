...
initialsmt=stormatrix(:,:,2);%stores the time evolution of cell 2
...
Mstc2=sum(ffes,3);
%Mstc2 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell2sectorsmt','Mstc2','-v7.3');
else
