...
initialsmt=stormatrix(:,:,5);%stores the time evolution of cell 5
...
Mstc5=sum(ffes,3);
%Mstc5 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell5sectorsmt','Mstc5','-v7.3');
else
