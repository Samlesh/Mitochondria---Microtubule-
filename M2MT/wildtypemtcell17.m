...
initialwmt=stormatrix(:,:,17);%stores the time evolution of cell 17
...
Mwtc17=sum(ffes,3);
%Mwtc17 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell17sectorwmt','Mwtc17');
else
