...
initialwmt=stormatrix(:,:,8);%stores the time evolution of cell 8
...
Mwtc8=sum(ffes,3);
%Mwtc8 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell8sectorwmt','Mwtc8');
else
