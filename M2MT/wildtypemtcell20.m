...
initialwmt=stormatrix(:,:,20);%stores the time evolution of cell 20
...
Mwtc20=sum(ffes,3);
%Mwtc20 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell20sectorwmt','Mwtc20');
else
