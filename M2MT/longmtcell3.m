...
initiallmt=stormatrix(:,:,3);%stores the time evolution of cell 3
...
Mltc3=sum(ffes,3);
%Mltc3 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell3sectorlmt','Mltc3','-v7.3');
else
