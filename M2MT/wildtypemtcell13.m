...
initialwmt=stormatrix(:,:,13);%stores the time evolution of cell 13
...
Mwtc13=sum(ffes,3);
%Mwtc13 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell13sectorwmt','Mwtc13');
else
