...
initiallmt=stormatrix(:,:,5);%stores the time evolution of cell 5
...
Mltc5=sum(ffes,3);
%Mltc5 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell5sectorlmt','Mltc5','-v7.3');
else
