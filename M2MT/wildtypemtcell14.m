...
initialwmt=stormatrix(:,:,14);%stores the time evolution of cell 14
...
Mwtc14=sum(ffes,3);
%Mwtc14 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell14sectorwmt','Mwtc14');
else
