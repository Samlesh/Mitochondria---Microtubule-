...
initialwmt=stormatrix(:,:,19);%stores the time evolution of cell 19
...
Mwtc19=sum(ffes,3);
%Mwtc19 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell19sectorwmt','Mwtc19');
else
