...
initiallmt=stormatrix(:,:,4);%stores the time evolution of cell 4
...
Mltc4=sum(ffes,3);
%Mltc4 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell4sectorlmt','Mltc4','-v7.3');
else
