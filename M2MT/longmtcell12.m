...
initiallmt=stormatrix(:,:,12);%stores the time evolution of cell 5
...
Mltc12=sum(ffes,3);
%Mltc12 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell12sectorlmt','Mltc12','-v7.3');
else
