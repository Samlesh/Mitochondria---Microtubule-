...
initialwmt=stormatrix(:,:,10);%stores the time evolution of cell 10
...
Mwtc10=sum(ffes,3);
%Mwtc10 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell10sectorwmt','Mwtc10');
else
