...
initialsmt=stormatrix(:,:,8);%stores the time evolution of cell 8
...
Mstc8=sum(ffes,3);
%Mstc8 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell7sectorsmt','Mstc8','-v7.3');
else
