...
initialsmt=stormatrix(:,:,1);%stores the time evolution of cell 1
...
Mstc1=sum(ffes,3);
%Mstc1 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell1sectorsmt','Mstc1','-v7.3');
else
