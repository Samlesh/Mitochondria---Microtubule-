...
initiallmt=stormatrix(:,:,9);%stores the time evolution of cell 5
...
Mltc9=sum(ffes,3);
%Mltc9 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell9sectorlmt','Mltc9','-v7.3');
else
