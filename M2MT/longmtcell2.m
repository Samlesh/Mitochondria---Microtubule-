...
initiallmt=stormatrix(:,:,2);%stores the time evolution of cell 2
...
Mltc2=sum(ffes,3);
%Mltc2 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell2sectorlmt','Mltc2','-v7.3');
else
