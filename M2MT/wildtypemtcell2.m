...
initialwmt=stormatrix(:,:,2);%stores the time evolution of cell 2
...
Mwtc2=sum(ffes,3);
%Mwtc2 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell2sectorwmt','Mwtc2');
else
