...
initialwmt=stormatrix(:,:,3);%stores the time evolution of cell 3
...
Mwtc3=sum(ffes,3);
%Mwtc3 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell3sectorwmt','Mwtc3');
else
