...
initiallmt=stormatrix(:,:,8);%stores the time evolution of cell 5
...
Mltc8=sum(ffes,3);
%Mltc8 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell8sectorlmt','Mltc8','-v7.3');
else
