...
initiallmt=stormatrix(:,:,14);%stores the time evolution of cell 5
...
Mltc14=sum(ffes,3);
%Mltc14 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell14sectorlmt','Mltc14','-v7.3');
else
