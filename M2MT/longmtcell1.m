...
initiallmt=stormatrix(:,:,1);%stores the time evolution of cell 1
...
Mltc1=sum(ffes,3);
%Mltc1 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell1sectorlmt','Mltc1','-v7.3');
else
