...
initialwmt=stormatrix(:,:,12);%stores the time evolution of cell 12
...
Mwtc12=sum(ffes,3);
%Mwtc12 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell12sectorwmt','Mwtc12');
else
