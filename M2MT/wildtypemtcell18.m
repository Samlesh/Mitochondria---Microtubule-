...
initialwmt=stormatrix(:,:,18);%stores the time evolution of cell 18
...
Mwtc18=sum(ffes,3);
%Mwtc18 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell18sectorwmt','Mwtc18');
else
