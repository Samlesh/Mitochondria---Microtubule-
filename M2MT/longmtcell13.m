...
initiallmt=stormatrix(:,:,13);%stores the time evolution of cell 5
...
Mltc13=sum(ffes,3);
%Mltc13 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell13sectorlmt','Mltc13','-v7.3');
else
