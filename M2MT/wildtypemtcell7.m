...
initialwmt=stormatrix(:,:,7);%stores the time evolution of cell 7
...
Mwtc7=sum(ffes,3);
%Mwtc7 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell7sectorwmt','Mwtc7');
else
