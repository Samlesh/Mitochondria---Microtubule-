...
initialwmt=stormatrix(:,:,5);%stores the time evolution of cell 5
...
Mwtc5=sum(ffes,3);
%Mwtc5 stores the averaged number of mitochondria present in each fragment
%corresponding to vaious time steps and the averaging is done across the
%realizations
toc
save('cell5sectorwmt','Mwtc5');
else
