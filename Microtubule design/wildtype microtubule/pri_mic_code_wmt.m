function [sl1,sll1,sl2,sll2,sl3,sll3,sl4,sll4,tts1,tts2,tts3,tts4,ttts1,ttts2,ttts3,ttts4,cc1,nume1,nume2,nume3,nume4,cat_l,catfreq1,catfreq2,catfreq3,catfreq4,ttv1,ttv2,ttv3,ttv4,pa1,pa2,pa3,pa4,ls1,ls2,ls3,ls4,simv1,simv2,simv3,simv4]=pri_mic_code_wmt(a,b,k_depolyedge)
...
load('wildmtld.mat');
lengthcount=numel(initialwildmt);
initialwildmt=round(initialwildmt,1);
tic
for i=1:1000
    cc(1)=3;
    stl=randi([1 lengthcount],4,1);
    stl1=initialwildmt(stl(1));stl2=initialwildmt(stl(2));
    stl3=initialwildmt(stl(3));stl4=initialwildmt(stl(4));
