function out=multivariopticatfreqelongvelshortmt(x)
...
[sl1,sll1,sl2,sll2,sl3,sll3,sl4,sll4,tts1,tts2,tts3,tts4,ttts1,ttts2,ttts3,ttts4,cc1,nume1,nume2,nume3,nume4,cat_l,catfreq1,catfreq2,catfreq3,catfreq4,ttv1,ttv2,ttv3,ttv4,pa1,pa2,pa3,pa4,lengths_m1,lengths_m2,lengths_m3,lengths_m4,vavgs_m1,vavgs_m2,vavgs_m3,vavgs_m4]=pri_mic_code_smt(a,b,k_depolyedge);
...
lchk=mean(avml);
m1=0.03; %m1 is the experimental elongation velocity
m2=1.32; %m2 is the experimental observed mean length
m4=0.0833;  %m4 is the experimental shrinkage velocity
