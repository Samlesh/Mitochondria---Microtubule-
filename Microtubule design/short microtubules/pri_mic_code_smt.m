function [sl1,sll1,sl2,sll2,sl3,sll3,sl4,sll4,tts1,tts2,tts3,tts4,ttts1,ttts2,ttts3,ttts4,cc1,nume1,nume2,nume3,nume4,cat_l,catfreq1,catfreq2,catfreq3,catfreq4,ttv1,ttv2,ttv3,ttv4,pa1,pa2,pa3,pa4,ls1,ls2,ls3,ls4,simv1,simv2,simv3,simv4]=pri_mic_code_smt(a,b,k_depolyedge)
...
load('shortmtld.mat');
lengthcount=numel(initialshortmt);
initialshortmt=round(initialshortmt,1);
tic
for i=1:1000
    cc(1)=3;
    stl=randi([1 lengthcount],4,1);
    stl1=initialshortmt(stl(1));stl2=initialshortmt(stl(2));
    stl3=initialshortmt(stl(3));stl4=initialshortmt(stl(4));
