...
for k=1:14   
    ...
    % being stored
    Mnilswiths(:,:,k)=nmt_with_sector(stormatrix(:,:,k));
...
save('nomtwithsector.mat','Mnilswiths');
%Mnilswiths saves the resulatant mitochondrial number with time in the matrix
%nomtwithsector.mat
