...
for k=1:8  
    ...
    % being stored
    Msilswiths(:,:,k)=smt_with_sector(stormatrix(:,:,k));
...
save('smallmtwithsector.mat',' Msilswiths');
%Msilswiths saves the resulatant mitochondrial number with time in the matrix
%smallmtwithsector.mat
