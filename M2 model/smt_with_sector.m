function [mitochondria]=smt_with_sector(principalmat)
...
fu(1,1)=0.025/(2*(8)^2);fu(1,2)=0.025/((8)^2);%stores the fusion 
                       %frequencies in the presence of microtubule(smt)
fu(2,1)=0.011/(2*(8)^2);fu(2,2)=0.011/((8)^2);%stores the fusion 
                         %frequencies in the absence of microtubule(no mt)
fi(1,1)=0.032*0.4/8;fi(1,2)=2*0.032*0.4/8;%stores the fission frequencies
                                   %in the presence of microtubles(smt)
fi(2,1)=0.027/8;fi(2,2)=2*0.027/8;%stores the fission frequencies
